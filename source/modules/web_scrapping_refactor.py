...
def get_news() -> List[cl.News]:
    ...
    for owner in ["antena3", "marca", "lasexta", "nytimes"]:
        news.append(NewsBuilder(owner).get_news)
...
class NewsBuilder:
    ...
    def get_news(self):
        ...
        return self._make_categories_news(structure) + self._make_news(structure, "general", self.date)
    
    def _get_urls(self, articles):
        urls = []
    ...
    def _build_news(self, titles: List[str], urls: List[str], imgs: List[str], category: str) -> List[cl.News]:
        news = []
    ...
    def _make_news(self, structure: BeautifulSoup, category: str) -> List[cl.News]:
        if self._class:
        ...
        return self._build_news(titles, urls, images, category)
    
    def get_news(self) -> List[cl.News]:
        return self.news
